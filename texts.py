...
1️⃣ سکه روزانه (رایگان):

هر روز از دکمه «🎁 سکه روزانه» یا دستور /daily یک جایزه تصادفی بگیر.

2️⃣ معرفی دوستان (رایگان) :

برای افزایش سکه به صورت رایگان بنر لینک⚡️ مخصوص خودت (/link) رو برای دوستات  بفرست و 20 سکه دریافت کن

3️⃣ خرید سکه بصورت آنلاین

4️⃣ معرفی کاربران متخلف :
